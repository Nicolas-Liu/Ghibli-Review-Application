...
const selectedMovieDetails = (selectedMovie) => {
    ...
    const movieimg = document.createElement('p');
    ...
    movieimg.innerHTML = `<img src="${selectedMovie.image}"/>`;
    movieimg.classList.add('movie-img');
    description.innerText = selectedMovie.description;
    moviedirector.innerText = "Director: " + selectedMovie.director;
    
    movieDetailTag.appendChild(title)
    movieDetailTag.appendChild(year)
    movieDetailTag.appendChild(movieimg)
    movieDetailTag.appendChild(description)
    movieDetailTag.appendChild(moviedirector)
}
